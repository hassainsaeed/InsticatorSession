...
*/
 function getSession() {
   ...
   if (doesSessionObjectExistInCookie() == false) {
     ...
     sessionObject = readSessionObjectFromCookie()
   }
   ...
   // We need to check if the session is expired (i.e. 30 minutes since last activity, or after midnight). If so, generate new session
...
*/
  ...
  *   "expiration": "2019-01-17 23:42:23:134" // Time at which the session object will expire. Either at 30 minutes after last activity or midnight. In human readable format. String.
 ...
 * Session ID is generated by selecting 10 characters at random from a list of all common ASCII characters, and joining them into a string
*/
...
*/
 function getExpirationTime() {
   ...
   // First check if we are less than 30 minutes til midnight (i.e. is it past 23:30:00?). All sessions expire at end of day (23:59:59:9999)
 ...
 /*
  ...
  // Output: The session object saved in the cookie. If session object not found in cookie, returns an empty object. JSON Object
